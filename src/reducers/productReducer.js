...
export const productsReducer = (state = { products: mockProducts, productsCount: mockProducts.length, resultPerPage: 12, filteredProductsCount: mockProducts.length }, { type, payload }) => {
